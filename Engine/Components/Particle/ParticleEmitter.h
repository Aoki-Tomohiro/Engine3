...
public:
	...
	/// 初期化
	/// </summary>
	/// <param name="popTranslation"></param>
	/// <param name="velocity"></param>
	/// <param name="color"></param>
	/// <param name="popFrequency"></param>
	/// <param name="particleLifeTime"></param>
	/// <param name="emitterLifeTime"></param>
	void Initialize(const Vector3& translation, const Vector3& velocity, const Vector4& color, float frequency, float particleLifeTime, float emitterLifeTime);
